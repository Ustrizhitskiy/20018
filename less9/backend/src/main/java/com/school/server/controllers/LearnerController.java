...
public class LearnerController {
    ...
    private static final Logger LOGGER = Logger.getLogger(LearnerController.class.getSimpleName());
    ...
    public String saveLearner(ModelMap model, @ModelAttribute("learnerForm") Learner learnerForm) {
        ...
        LOGGER.warn("you have create a new user");
    ...
    @RequestMapping(value = {"/find with id = 3"}, method = RequestMethod.GET)  // Событие из <a href="find with id = 3">
